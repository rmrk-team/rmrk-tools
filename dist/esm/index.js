...
var fetchRemarks = (api, from, to, prefixes) => __awaiter(void 0, void 0, void 0, function* () {
    const bcs = [];
    for (let i = from; i <= to; i++) {
        ...
        const blockHash = yield api.rpc.chain.getBlockHash(i);
        ...
        exLoop: for (const ex of block.block.extrinsics) {
            ...
            if (section === "system" && method === "remark") {
                ...
                if (remarkExists) {
                    const records = yield api.query.system.events.at(blockHash);
...
export { Collection as c100, Consolidator as consolidator, fetchRemarks, NFT as n100 };
